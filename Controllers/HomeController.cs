...
namespace Coffee_Shop2.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            // رسالة بسيطة تظهر عند تشغيل الموقع
            return Content("☕ Coffee Shop App is live! Database is disabled temporarily for CV purposes.");
        }

        // صفحة about
        public IActionResult About()
        {
            return View(); // تأكد من وجود View باسم About.cshtml
        }

        // إذا بدك تعرض صفحات إضافية ثابتة بدون داتا بيز، ممكن تضيفها هنا بنفس الطريقة
    }
}